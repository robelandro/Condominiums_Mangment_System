...
public class StartUpController {
    ...
    public void adminCreate(ActionEvent event){
        ...
        String sqlSift ="CREATE TABLE Shift (StaffName VARCHAR(100),Responsible VARCHAR(100),Monday VARCHAR(100),Tuesday VARCHAR(100),Wednesday VARCHAR(100),Thursday VARCHAR(100),Friday VARCHAR(100),Saturday VARCHAR(100),Sunday VARCHAR(100))";

        String sqlStaff ="CREATE TABLE Staff (FirstName VARCHAR(100), NameId VARCHAR(100), LastName VARCHAR(100), Age VARCHAR(100), Address VARCHAR(100), Sex VARCHAR(100), Responsibility VARCHAR(100))";

        String sqlPayment = "CREATE TABLE PaymentTable (NumCount INTEGER GENERATED BY DEFAULT AS IDENTITY, Name VARCHAR(30), ResidentId VARCHAR(80), PaymentPurpose VARCHAR(80), PaymentAmount VARCHAR(80), DateAndTime VARCHAR(20))";

        String sqlResident ="CREATE TABLE Resident (NumCount VARCHAR(30), ResidentId VARCHAR(30),FirstName VARCHAR(10), LastName VARCHAR(10), Age VARCHAR(3), Sex VARCHAR(10), PhoneNumber VARCHAR(20), BlockNumber VARCHAR(5), HouseNumber VARCHAR(10), RentStatus VARCHAR(10),Area VARCHAR(20),Floor VARCHAR(20),Part VARCHAR(20),Money VARCHAR(20),Scenario VARCHAR(255),SaleOr VARCHAR(20))";

        String sqlCar = "CREATE TABLE Car (FirstName VARCHAR(255), ResidentId VARCHAR(255), TypeOfCar VARCHAR(255), PlateNumber VARCHAR(255))";

        String houseHold ="CREATE TABLE HouseHold (FirstName VARCHAR(255), ResidentId VARCHAR(255), NameOfObject VARCHAR(255), Risky VARCHAR(255))";

        String sqlParking ="CREATE TABLE Parking (NumCount VARCHAR(255))";
        ...
        if (check && !getNumberOfHouse().getText().isEmpty() && checkForInteger()){
            ...
            sqlDataMode.createTable(sqlPayment);
            sqlDataMode.createTable(sqlCar);
            sqlDataMode.createTable(sqlParking);
            sqlDataMode.createTable(houseHold);
            sqlDataMode.createTable(sqlStaff);
            sqlDataMode.createTable(sqlSift);
